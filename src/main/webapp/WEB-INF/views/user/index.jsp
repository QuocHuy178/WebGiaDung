			...
			<div class="row">
				...
				<div class="span9">
					<div class="well well-small">
						<h4>
							Sản phẩm nổi bật <small class="pull-right text-error">${ productsHot.size() + productsHotLast.size() } Sản phẩm</small>
						</h4>
						<div class="row-fluid">
														...
														<div class="caption">
															...
															<h4 class="text-center flex-column">
																<span class="pull-right text-warning"> <fmt:formatNumber
																	...
																	href='<c:url value="/product_details/${ item.id }"/>'>Xem</a>
															</h4>
														</div>
													</div>
												</li>
					...
					<ul class="thumbnails">
						<c:choose>
										...
										<div class="thumbnail">
											...
											<div class="caption">
												...
												<h4 style="text-align: center">
													...
													<a class="btn btn-warning" href="product_details.php">
							...
							<c:otherwise>
								<h5 class="text-success text-center">Shop hiện chưa có sản phẩm mới
									nào!!</h3>
							</c:otherwise>
						</c:choose>
					</ul>
